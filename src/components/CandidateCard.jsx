...
import { Lock, ShieldCheck, MapPin, Briefcase, Phone, Mail, Sparkles, ArrowRight } from "lucide-react";

const CandidateCard = ({ candidate, index, isUnlocked, onUnlock, onClick }) => {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      // Removed max-w-md and mx-auto to allow expansion
    ...
    >
      ...
      <motion.button
        whileHover={{
          scale: 1.02,
          boxShadow: "0 4px 12px rgba(32, 120, 244, 0.3)",
        }}
        whileTap={{ scale: 0.98 }}
        onClick={onClick}
